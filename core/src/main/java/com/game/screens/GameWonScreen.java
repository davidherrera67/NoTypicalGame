...
public class GameWonScreen extends BaseScreen{
    ...
    public GameWonScreen(Game game) {
        ...
        gameWonTittle = new Image(game.getManager().get("images/gameWonTittle.png", Texture.class));
        ...
        gameWonTittle.setPosition((Gdx.graphics.getWidth() / 2.5f) - 200f, Gdx.graphics.getHeight() / 1.8f);
